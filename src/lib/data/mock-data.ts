...
export const mockExperiences: Experience[] = [
  ...
  },
  {
    ...
    org: 'Web3 & DeFi Projects',
    location: 'Remote',
    start_date: '2023-05-01',
    end_date: null,
    description: 'Developing and auditing secure smart contracts for decentralized applications. Integrating frontend interfaces with blockchain networks using Ethers.js and Wagmi.',
    highlights: [
      'Built custom NFT marketplaces and staking contracts',
      'Integrated Web3 wallets and blockchain interactions into Next.js apps',
      'Conducted preliminary security audits for Solidity contracts',
    ],
    sort_order: 2,
    is_published: true,
  },
...
export const mockSkills: Skill[] = [
  ...
  { id: '30000000-0000-0000-0000-000000000018', name: 'Solidity', category: 'language', proficiency: 4, sort_order: 14 },
  { id: '30000000-0000-0000-0000-000000000019', name: 'Web3.js / Ethers', category: 'framework', proficiency: 4, sort_order: 15 },
  { id: '30000000-0000-0000-0000-000000000020', name: 'Smart Contracts', category: 'tool', proficiency: 4, sort_order: 16 },
  { id: '30000000-0000-0000-0000-000000000015', name: 'Creative Writing', category: 'creative', proficiency: 5, sort_order: 17 },
  { id: '30000000-0000-0000-0000-000000000016', name: 'Crochet', category: 'creative', proficiency: 3, sort_order: 18 },
  { id: '30000000-0000-0000-0000-000000000017', name: 'Illustration', category: 'creative', proficiency: 3, sort_order: 19 },
]
...
export const mockProjects: Project[] = [
  ...
  },
  {
    ...
    summary: 'A Web3 decentralized exchange interface built with Next.js and Ethers.js, featuring real-time token swapping and liquidity pool management.',
    problem: 'Many DeFi interfaces are overly complex and fail to provide clear feedback during transaction processing, leading to poor user experiences.',
    solution: 'Designed and built a streamlined Web3 frontend that interacts with custom Solidity smart contracts. Implemented clear transaction state management, human-readable errors, and a responsive glassmorphism UI.',
    stack: ['Next.js', 'TypeScript', 'Solidity', 'Ethers.js', 'Tailwind CSS', 'Wagmi'],
    role: 'Blockchain Engineer & Frontend Dev',
    outcome: 'Successfully deployed a testnet version with simulated liquidity. The clean UI significantly improved the speed at which users could complete swaps compared to standard DEX templates.',
    live_url: null,
    repo_url: null,
    cover_image_url: null,
    gallery: null,
